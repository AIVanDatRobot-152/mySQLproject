...
def query_data(event=None):
    try:
        ...
        if search_term.isdigit():
            sql = "SELECT Video_Id, Video_name, Video_data, Description_Video FROM video_data WHERE Video_Id = %s"
            cursor.execute(sql, (search_term,))
        else:
            sql = "SELECT Video_Id, Video_name, Video_data, Description_Video FROM video_data WHERE Video_name = %s"
            cursor.execute(sql, (search_term,))
...
label_search = Label(root, text="Enter Video ID or Name:")
